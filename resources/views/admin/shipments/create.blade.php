                ...
                <form method="POST" action="{{ route('admin.shipments.store') }}">
                    ...
                    <div class="row g-3 g-sm-4 mb-4">
                        <div class="col">
                            ...
                            <input type="text" class="form-control form-control-lg @error('sender_name') is-invalid @enderror" id="sender_name" name="sender_name" placeholder="Enter sender's name" value="{{ old('sender_name') }}">
                            @error('sender_name')
                        ...
                        <div class="col">
                            ...
                            <input type="email" class="form-control form-control-lg @error('sender_email') is-invalid @enderror" id="sender_email" name="sender_email" placeholder="Enter sender's email address" value="{{ old('sender_email') }}">
                            @error('sender_email')
                            <div class="invalid-feedback">{{ $message ?? 'Please enter a valid sender\'s email.' }}</div>
                            @enderror
                        </div>

                        <div class="col-12">
                            <label for="sender_address" class="form-label">Sender's Address <span class="text-danger">*</span></label>
                            <input type="text" class="form-control form-control-lg @error('sender_address') is-invalid @enderror" id="sender_address" name="sender_address" placeholder="Enter sender's address" value="{{ old('sender_address') }}">
                    ...
                    <div class="row g-3 g-sm-4 mb-4">
                        <div class="col">
                            ...
                            <input type="text" class="form-control form-control-lg @error('receiver_name') is-invalid @enderror" id="receiver_name" name="receiver_name" placeholder="Enter receiver's name" value="{{ old('receiver_name') }}">
                            @error('receiver_name')
                        ...
                        <div class="col">
                            ...
                            <input type="email" class="form-control form-control-lg @error('receiver_email') is-invalid @enderror" id="receiver_email" name="receiver_email" placeholder="Enter receiver's email address" value="{{ old('receiver_email') }}">
                            @error('receiver_email')
                            <div class="invalid-feedback">{{ $message ?? 'Please enter a valid receiver\'s email.' }}</div>
                            @enderror
                        </div>

                        <div class="col-12">
                            <label for="receiver_address" class="form-label">Receiver's Address <span class="text-danger">*</span></label>
                            <input type="text" class="form-control form-control-lg @error('receiver_address') is-invalid @enderror" id="receiver_address" name="receiver_address" placeholder="Enter receiver's address" value="{{ old('receiver_address') }}">
                            @error('receiver_address')
                            <div class="invalid-feedback">{{ $message ?? 'Please enter the receiver\'s address.' }}</div>
                            @enderror
                        </div>
                    </div>
                        ...
                        <div class="row row-cols-1 row-cols-sm-2 g-3 g-sm-4 mb-4">
                            <div class="col">
                                ...
                                <select class="form-select form-control-lg @error('origin') is-invalid @enderror" id="origin" name="origin">
                                    ...
                                    @foreach($countries as $country)
                                        <option value="{{ Str::snake($country['name']) }}" {{ old('origin') == Str::snake($country['name']) ? 'selected' : '' }}>{{ $country['name'] }}</option>
                                    @endforeach
                                </select>
                                @error('origin')
                            ...
                            <div class="col">
                                ...
                                <select class="form-select form-control-lg @error('destination') is-invalid @enderror" id="destination" name="destination">
                                    ...
                                    @foreach($countries as $country)
                                        <option value="{{ Str::snake($country['name']) }}" {{ old('destination') == Str::snake($country['name']) ? 'selected' : '' }}>{{ $country['name'] }}</option>
                                    @endforeach
                                </select>
                                @error('destination')
                            ...
                            <div class="col">
                                ...
                                <select class="form-select form-control-lg @error('shipment_type') is-invalid @enderror" id="shipment_type" name="shipment_type">
                                    ...
                                    <option value="standard" {{ old('shipment_type') == 'standard' ? 'selected' : '' }}>Standard</option>
                                    <option value="express" {{ old('shipment_type') == 'express' ? 'selected' : '' }}>Express</option>
                                    <option value="overnight" {{ old('shipment_type') == 'overnight' ? 'selected' : '' }}>Overnight</option>
                                    <option value="international_shipping" {{ old('shipment_type') == 'international_shipping' ? 'selected' : '' }}>International Shipping</option>
                                    <option value="local" {{ old('shipment_type') == 'local' ? 'selected' : '' }}>Local</option>
                                    <option value="air_freight" {{ old('shipment_type') == 'air_freight' ? 'selected' : '' }}>Air Freight</option>
                                    <option value="truckload" {{ old('shipment_type') == 'truckload' ? 'selected' : '' }}>Truckload</option>
                                    <option value="van_move" {{ old('shipment_type') == 'van_move' ? 'selected' : '' }}>Van Move</option>
                                    <option value="ocean_freight" {{ old('shipment_type') == 'ocean_freight' ? 'selected' : '' }}>Ocean Freight</option>
                            ...
                            <div class="col">
                                ...
                                <select class="form-select form-control-lg @error('payment_mode') is-invalid @enderror" id="payment_mode" name="payment_mode">
                                    ...
                                    <option value="cash_on_delivery" {{ old('payment_mode') == 'cash_on_delivery' ? 'selected' : '' }}>Cash on Delivery</option>
                                    ...
                                    <option value="mobile_payment" {{ old('payment_mode') == 'mobile_payment' ? 'selected' : '' }}>Mobile Payment</option>
                            ...
                            <div class="col-lg-6 col-sm-6">
                                ...
                                <input type="text" class="form-control form-control-lg @error('shipped_via') is-invalid @enderror" id="shipped_via" name="shipped_via" placeholder="Shipped via" value="{{ old('shipped_via', config('app.name')) }}" readonly>
                                @error('shipped_via')
                            ...
                            <div class="col-lg-6 col-sm-6">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg @error('departure_date') is-invalid @enderror" name="departure_date" id="departure_date" data-datepicker='{"minDate": "today"}' placeholder="Choose date" value="{{ old('departure_date') }}">
                            ...
                            <div class="col-lg-6 col-sm-6">
                                ...
                                <div class="input-group mb-3">
                                    <span class="input-group-text"><i class="ci-calendar"></i></span>
                                    <input type="text" class="form-control form-control-lg @error('arrival_date') is-invalid @enderror" name="arrival_date" id="arrival_date" data-datepicker='{"minDate": "today"}' placeholder="Choose date" value="{{ old('arrival_date') }}">
                                    @error('arrival_date')
                            ...
                            <div class="col">
                                ...
                                <select class="form-select form-control-lg @error('status') is-invalid @enderror" id="status" name="status">
                                    ...
                                    <option value="held_by_customs" {{ old('status') == 'held_by_customs' ? 'selected' : '' }}>Held by Customs</option>
                                    <option value="on_hold" {{ old('status') == 'on_hold' ? 'selected' : '' }}>On Hold</option>
                                    <option value="awaiting_pickup" {{ old('status') == 'awaiting_pickup' ? 'selected' : '' }}>Awaiting Pickup</option>
                    ...
                    <div class="form-check mb-4">
                        <input type="checkbox" checked name="notify_receiver" class="form-check-input" id="notify_receiver" value="1" {{ old('notify_receiver') ? 'checked' : '' }}>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="comments" name="comments" class="form-control form-control-lg @error('comments') is-invalid @enderror" rows="3" placeholder="Any additional message or comments" aria-describedby="commentsHelp">{{ old('comments') }}</textarea>
                        @error('comments')
